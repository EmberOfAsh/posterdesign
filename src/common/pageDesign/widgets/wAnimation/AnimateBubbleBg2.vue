  ...
  methods: {
    ...
    doDraw() {
      ...
      function ColorPoint(x, y, color) {
        ...
        this.color = function() {
          return new Color(
            lerp(this.oldColor.h, this.newColor.h, this.step),
        ...
        for (let i = 0; i < options.bokeh.count; i++) {
          circles.push(
            new BokehCircle(
              Math.random(),
              Math.random(),
              rand(options.bokeh.size),
              rand(options.bokeh.alpha)
            )
          );
      ...
      function render() {
        ...
        colorPoints.forEach(function(point) {
          ...
          var grad = gradientBuffer.createRadialGradient(
            x,
            y,
            options.gradient.smallRadius,
            x,
            y,
