      ...
      <el-collapse-item title="样式设置" name="2">
        ...
        <div id="value-input-select">
          ...
          <el-select
            ...
            placeholder="请选择"
            @change="selectFont">
            <el-option v-for="item in fontsList" :key="item.id" :label="item.fontName" :value="item.fontName">
              <img class="font-preview" :src="item.url"/>
            </el-option>
          </el-select>
        </div>
        ...
        <div class="line-layout style-item">
          <color-select label="字体颜色" v-model="innerElement.textColor" @finish="changeFontColor" />
...
export default {
  ...
  methods: {
    ...
    changeFontColor(value){
      this.finish('textColor', domUtil.rgb2hex(value))
    },
    loadFontsInfo(){
      let ins = this;
