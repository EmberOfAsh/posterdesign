<template>
  <div id="w-text-style">
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item title="播放控制" name="2">
        <div class="line-layout style-item">
        <div id="color-select">
          <span class="label">自动播放</span>
          <el-switch
            v-model="innerElement.video.autoplay"
            active-color="#13ce66"
        ...
        <div id="color-select">
          <span class="label">播放静音</span>
          <el-switch
            v-model="innerElement.video.muted"
            active-color="#13ce66"
            inactive-color="#ff4949"
            >
          </el-switch>
        ...
        <div id="color-select">
          ...
          <el-switch
            v-model="innerElement.video.loop"
            active-color="#13ce66"
            inactive-color="#ff4949"
            >
          </el-switch>
        ...
        <div id="color-select">
          <span class="label">播放控件</span>
          <el-switch
            v-model="innerElement.video.controls"
            active-color="#13ce66"
            inactive-color="#ff4949"
            >
          </el-switch>
...
export default {
  ...
  data() {
    return {
      ...
      lineHeightList: ["1", "1.1", "1.25", "1.5", "1.75", "2"],
