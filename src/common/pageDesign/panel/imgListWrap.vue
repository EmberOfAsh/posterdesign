<template>
  <div id="img-list-wrap">
    <div class="style-tab">
      <span class="tab" :class="{'active-tab' : activeTab === 0}" @click="activeTab = 0">模版素材</span>
  ...
  data() {
    return {
      ...
      templateResource: [
        ...
        {
          id: 6,
          url: require("../../../assets/images/font-bg.png"),
          ratio: 32 / 101
        },
        {
          id: 7,
        ...
        {
          id: 10,
          url: require("../../../assets/images/20180831-144716-f64d.png"),
          ratio: 750 / 510
        }
      ],
      recommendImgList: [
